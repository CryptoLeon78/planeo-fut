...
const ENGLISH: Record<string, string> = {
  ...
  "Crea ejercicios, sesiones, microciclos y temporadas completas. Diseñado para fútbol base, cantera, amateur y alto rendimiento.":
    "Build practices, training sessions, microcycles and complete season plans. Designed for grassroots, academy, amateur and high-performance football.",
  ...
  "Tu panel de control para diseñar entrenamientos profesionales.":
    "Your coaching hub for building professional training programmes.",
  "Sesiones recientes": "Recent training sessions",
  "Ver todas": "View all",
  "Aún no hay sesiones": "No training sessions yet",
  "Crea tu primera sesión combinando ejercicios en bloques.":
    "Build your first session by organising practices into training blocks.",
  ...
  "Crea, filtra y reutiliza ejercicios con ficha completa.":
    "Create, filter and reuse detailed football practices.",
  ...
  "Crea tu primer ejercicio para empezar tu biblioteca.":
    "Create your first practice to start building your library.",
  "Prueba a ajustar la búsqueda o quitar filtros.":
    "Try refining your search or clearing the filters.",
  "Crear ejercicio": "Create practice",
  Favorito: "Favourite",
  "jug.": "players",
  "Agrupa ejercicios en bloques estructurados.":
    "Organise practices into structured training blocks.",
  Plantilla: "Template",
  Abrir: "Open",
  Duplicar: "Duplicate",
  Eliminar: "Delete",
  "Aún no tienes sesiones": "You have no training sessions yet",
  "Combina ejercicios en bloques: calentamiento, parte principal, juego y vuelta a la calma.":
    "Combine practices into warm-up, main phase, conditioned game and cool-down blocks.",
  "Crear sesión": "Create training session",
  "3 entrenamientos + partido (sábado o domingo).":
    "Three training days plus a Saturday or Sunday fixture.",
  ...
  "Planifica tu semana con 3 sesiones y partido. Cada slot tendrá su carga e intención.":
    "Plan three training days and a fixture. Give each slot its own load and coaching intent.",
  ...
  "Valora cómo fue el entrenamiento. Se guarda automáticamente.":
    "Review the session outcome. Changes are saved automatically.",
  "Guardando…": "Saving…",
  ...
  "Ejercicios, sesiones, microciclos y temporadas completas en una sola herramienta diseñada para entrenadores serios.":
    "Practices, sessions, microcycles and complete season plans in one workspace for ambitious coaches.",
  ...
  "Objetivo táctico (ej. presión, centros, salida de balón)…":
    "Coaching outcome (e.g. pressing, crossing, playing out)…",
...
function localiseDom(root: ParentNode, language: AppLanguage) {
  ...
  if (root instanceof Element) {
    [root, ...Array.from(root.querySelectorAll("[placeholder], [aria-label], [title]"))].forEach(
      (element) => {
      ...
      records.forEach((record) => {
        record.addedNodes.forEach((node) => {
          if (node.nodeType === Node.TEXT_NODE && node.parentNode)
            localiseDom(node.parentNode, language);
...
export function exportToPdf(recordName: string) {
  ...
  const prefix =
    language === "en-GB" ? "PlaneoFUT — Training plan" : "PlaneoFUT — Plan de entrenamiento";
