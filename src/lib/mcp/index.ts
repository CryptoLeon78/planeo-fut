...
export default defineMcp({
  ...
  title: "PlaneoFUT",
  version: "0.2.0",
  instructions: "Manage the signed-in coach's private PlaneoFUT exercise library, training sessions and weekly football microcycles. Every write stores a version snapshot, so prefer update_* and restore_version over recreating records. Ask before calling creation, update, duplication or restore tools.",
