...
export default defineAuthedTool({
  ...
  description:
    "Create a complete football practice in the signed-in coach's library for later session planning.",
  inputSchema: {
    ...
    durationMinutes: z
      ...
      .max(240)
      .optional()
      .describe("Planned duration in minutes (1-240)."),
    playersCount: z
      .number()
      .int()
      .min(1)
      .max(40)
      .optional()
      .describe("Recommended number of players (1-40)."),
    ...
    observations: longText(2000)
      .optional()
      .describe("Organisation, coaching points and constraints."),
    tags: z
      .array(z.string().trim().min(1).max(30))
      .max(20)
      .optional()
      .describe("Short searchable labels (max 20)."),
  ...
  handler: async (input, ctx, userId) => {
    ...
    return toolSuccess(`Created exercise “${data.name}” (version ${version}).`, {
      exercise: data,
      version,
    });
  },
